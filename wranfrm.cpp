...
const double wrframe::frame_len       =    10e-3; // s
const double wrframe::bandwidth       = 2e6*0.92; // Hz
const double wrframe::carrier_spacing =      4e3; // Hz
const size_t wrframe::prefix_divider  =       50;
const size_t wrframe::pilot_fraction  =        5;
...
wrframe::wrframe(double sample_rate, size_t prefix_fraction)
...
wrframegen::wrframegen(double sample_rate, size_t prefix_fraction, size_t phy_mode)
...
bool wrframegen::write(complex<float>* buffer, size_t buffer_len) {
...
bool wrframesync::execute(complex<uint8_t>* buffer, size_t buffer_len) {
...
bool wrframesync::execute(complex<int8_t>* buffer, size_t buffer_len) {
